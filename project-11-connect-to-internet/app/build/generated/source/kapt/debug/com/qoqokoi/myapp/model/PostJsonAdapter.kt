...
public class PostJsonAdapter(
  ...
  public override fun toString(): String = buildString(26) {
      append("GeneratedJsonAdapter(").append("Post").append(')') }

  public override fun fromJson(reader: JsonReader): Post {
  ...
  public override fun toJson(writer: JsonWriter, value_: Post?): Unit {
    if (value_ == null) {
